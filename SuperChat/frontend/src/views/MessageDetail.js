              ...
              <div className="col-12 col-lg-7 col-xl-9">
                ...
                <div className="position-relative">
                  <div className="chat-messages p-4">
                    ...
                    <>
                      {message.sender.id !== user_id &&  
                        <div className="chat-message-left pb-1" key={index}>
                          <div>
                          ...
                          <div className="text-muted small text-nowrap mt-2">received {moment.utc(message.date).local().startOf('seconds').fromNow()}</div>

                        </div>
                      }
                      {message.sender.id === user_id &&  
                        <div className="chat-message-right pb-1" key={index}>
                          {/* <div>
                            <br />
                          </div> */}
                          ...
                          <div className="text-muted small text-nowrap mt-2 align-right">sent {moment.utc(message.date).local().startOf('seconds').fromNow()}</div>
